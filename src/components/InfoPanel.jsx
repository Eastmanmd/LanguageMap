...
export default function InfoPanel({ selectedStateId, selectedStateName }) {
  ...
  return (
    <div className="p-5">
      <h2 className="text-lg font-semibold text-gray-900">{selectedStateName}</h2>
          ...
          return (
            <li key={id}>
              <button
                ...
                className="w-full rounded-lg border border-gray-200 px-3 py-2.5 text-left hover:border-blue-300 hover:bg-blue-50"
              >
