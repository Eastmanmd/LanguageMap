    ...
    <div className="relative w-full max-w-sm">
      <div className="relative">
        <input
          ...
          className="w-full rounded-lg border border-gray-200 py-2 pl-3 pr-8 text-sm text-gray-900 placeholder:text-gray-400 focus:border-blue-400 focus:outline-none"
        />
      ...
      {isOpen && matches.length > 0 && (
        <ul className="absolute z-10 mt-1 w-full max-h-64 overflow-y-auto rounded-lg border border-gray-200 bg-white py-1 shadow-lg">
          {matches.map((lang) => (
            <li key={lang.id}>
              <button
                type="button"
